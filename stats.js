/* ============================================================
   stats.js
   شريط الإحصائيات — مُستخرَج من main.js

   الترتيب في index.html (بعد categories.js):
       <script src="categories.js"></script>
       <script src="stats.js"></script>

   المتغيرات والدوال التي يعتمد عليها من ملفات أخرى:
       parseNum, fmtNum — utils.js
       allData — map.js
       categories — categories.js
       selectedItems, selectedStatuses, equipmentRawRows,
       equipmentRawHeaders — main.js
